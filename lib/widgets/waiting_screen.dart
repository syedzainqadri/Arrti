...
class _WaitingScreenState extends State<WaitingScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  textStyle3(StringsManager.name, TextAlign.center, ColorManager.primaryColor),
            ...
            Padding(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  textStyle3(StringsManager.number, TextAlign.center, ColorManager.primaryColor),
            ...
            Padding(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  textStyle3(StringsManager.eEmail, TextAlign.center, ColorManager.primaryColor),
            ...
            Padding(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  textStyle3(StringsManager.businessName, TextAlign.center, ColorManager.primaryColor),
            ...
            Padding(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  textStyle3(StringsManager.memberSince, TextAlign.center, ColorManager.primaryColor),
            ...
            Padding(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  textStyle3(StringsManager.membershipStatus, TextAlign.center, ColorManager.primaryColor),
                  textStyle2(businessInfoModel!.membershipStatus != false ? "Active" : "In-Active", TextAlign.center, ColorManager.primaryColor),
                ],
              ),
            ),
      ...
      ): Center(child: textStyle3(StringsManager.noData, TextAlign.center, ColorManager.primaryColor)),
    );
  }
