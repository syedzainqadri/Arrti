...
class UpdateBusinessProfile extends StatefulWidget {
  ...
  const UpdateBusinessProfile({Key? key, required this.businessInfoModel}) : super(key: key);
...
class _UpdateBusinessProfileState extends State<UpdateBusinessProfile> {
  ...
  final BusinessProfileUpdateController businessProfileUpdateController = Get.put(BusinessProfileUpdateController());
  ...
  void initState() {
    ...
    selectedCity = widget.businessInfoModel.city!;
    selectedProvince = widget.businessInfoModel.province!;
    selectedDistrict = widget.businessInfoModel.district!;
    selectedMandi = widget.businessInfoModel.mandiName!;
  }
                  ...
                  children: [
                    ...
                    CircleAvatar(
                     ...
                     CircleAvatar(
                      radius: 50,
                      backgroundColor: ColorManager.grayColor,
                      backgroundImage: NetworkImage(widget.businessInfoModel.profileImage!),
                    )
                    :const CircleAvatar(
                      radius: 50,
                      backgroundColor: ColorManager.grayColor,
                ...
                onTap: () {
                  if(_formKey.currentState!.validate()){
                    ...
                    if(widget.businessInfoModel.profileImage != null){
                      businessProfileUpdateController.updateBusinessDataWithImage(businessNameController.text.trim(), addressController.text.trim(),
                          emailController.text.trim(), phoneController.text.trim(), ntnController.text.trim(),
                          selectedCity!, selectedProvince!, selectedDistrict!, selectedMandi!, formatted!,widget.businessInfoModel.profileImage!);
                    } else if(cameraImage != null){
                      businessProfileUpdateController.updateData(businessNameController.text.trim(), addressController.text.trim(),
                          emailController.text.trim(), phoneController.text.trim(), ntnController.text.trim(),
