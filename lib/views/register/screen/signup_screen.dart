...
import 'package:apni_mandi/views/register/components/signup_no_account_text.dart';
                ...
                onTap: () {
                  if(_formKey.currentState!.validate()){
                    ...
                    if(passwordController.text == confirmPasswordController.text){
                      _authController.register( nameController.text.trim(),
                        emailController.text.trim(), passwordController.text.trim(),
                      );
                    }else{
                      errorToast(StringsManager.error, StringsManager.passUnMatch);
                    }
