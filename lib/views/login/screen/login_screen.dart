...
import '../components/login_no_account_text.dart';
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              Center(
                child: textStyle7(StringsManager.welcome, TextAlign.center,
                    ColorManager.primaryColor),
              ),
              buildSpaceVertical(1.5.h),
              Center(
                child: textStyle2(StringsManager.loginText, TextAlign.center,
              ...
              Row(
                ...
                children: [
                  InkWell(
                    ...
                    child: textStyle1_5(StringsManager.forgotPass,
                        TextAlign.end, ColorManager.primaryColor),
                  ),
              ...
              InkWell(
                onTap: () {
                  if (_formKey.currentState!.validate()) {
                    ...
                    _authController.login(emailController.text.trim(),
