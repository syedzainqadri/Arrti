...
import 'dart:io';
import 'package:apni_mandi/controllers/personal_profile_completion_controller.dart';
...
class PersonalProfileCompletion extends StatefulWidget {
  ...
  @override
  State<PersonalProfileCompletion> createState() => _PersonalProfileCompletionState();
}
...
class _PersonalProfileCompletionState extends State<PersonalProfileCompletion> {
  ...
  String? selectedProvince;
   ...
   final PersonalProfileCompletionController _profileCompletionController = Get.put(PersonalProfileCompletionController());
                ...
                onTap: () {
                  if(_formKey.currentState!.validate()){
                    _formKey.currentState!.save();
                        ...
                        if(cameraImage != null){
                          _profileCompletionController.uploadData(firstNameController.text.trim(), lastNameController.text.trim(),
